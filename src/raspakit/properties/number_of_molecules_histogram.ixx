...
export struct PropertyNumberOfMoleculesHistogram
{
  ...
  PropertyNumberOfMoleculesHistogram(size_t numberOfBlocks, std::pair<size_t, size_t> range, size_t size, size_t sampleEvery, size_t writeEvery)
      : numberOfBlocks(numberOfBlocks), 
        ...
        bookKeepingEnergyHistogram(std::vector<std::vector<std::vector<double>>>(numberOfBlocks, std::vector<std::vector<double>>(numberOfBins, std::vector<double>(size)))),
  ...
  void addSample(size_t blockIndex, size_t currentCycle, std::vector<size_t> numberOfIntegerMoleculesPerComponent, const double &weight);
  ...
  friend Archive<std::ofstream> &operator<<(Archive<std::ofstream> &archive, const PropertyNumberOfMoleculesHistogram &hist);

...
{
bool insideBlockedPockets(const std::vector<Framework> &frameworks, const Component &component, std::span<const Atom> molecule_atoms);

[[nodiscard]] const std::vector<std::pair<Atom, RunningEnergy>> computeExternalNonOverlappingEnergies(
    const std::vector<Framework> &frameworks, const Component &component,

...
{
  ForceField forceField = ForceField({PseudoAtom("CH4", 16.04246, 0.0, 0.0, 6, false)}, {VDWParameters(158.5, 3.72)},
                                     ForceField::MixingRule::Lorentz_Berthelot, 12.0, false, false, false);
...
TEST(spacegroup, TestLennardJonesVDWMethaneInITQ_29_P1)
{
  ForceField forceField =
      ForceField({PseudoAtom("Si", 28.0855, 2.05, 0.0, 14, false), PseudoAtom("O", 15.999, -1.025, 0.0, 8, false),
                  PseudoAtom("CH4", 16.04246, 0.0, 0.0, 6, false)},
                 {VDWParameters(22.0, 2.30), VDWParameters(53.0, 3.3), VDWParameters(158.5, 3.72)},
                 ForceField::MixingRule::Lorentz_Berthelot, 12.0, true, false, false);
...
TEST(spacegroup, TestLennardJonesVDWMethaneInMFI)
{
  ForceField forceField =
      ForceField({PseudoAtom("Si", 28.0855, 2.05, 0.0, 14, false), PseudoAtom("O", 15.999, -1.025, 0.0, 8, false),
                  PseudoAtom("CH4", 16.04246, 0.0, 0.0, 6, false)},
                 {VDWParameters(22.0, 2.30), VDWParameters(53.0, 3.3), VDWParameters(158.5, 3.72)},
                 ForceField::MixingRule::Lorentz_Berthelot, 12.0, true, false);
